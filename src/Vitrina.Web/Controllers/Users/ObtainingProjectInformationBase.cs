...
public abstract class ObtainingProjectInformationBase(IMediator mediator)
{
    ...
    /// </summary>
    public virtual async Task<ICollection<ProjectPageDto>> GetProjectPages([FromRoute] int id, CancellationToken cancellationToken)
    {
    ...
    /// </summary>
    public virtual async Task<ICollection<PreviewProjectDto>> GetProjects([FromRoute] int id, CancellationToken cancellationToken)
    {
