...
namespace Vitrina.Infrastructure.DataAccess.Migrations
{
    ...
    [Migration("20250923091028_AddedModeration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vitrina.Domain.Project.Page.ModeratorView", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Vitrina.Domain.Project.Page.VerificationResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Vitrina.Domain.Project.Page.ModeratorView", b =>
                {
                    b.HasOne("Vitrina.Domain.User.User", "Administrator")
                        .WithMany()
            ...
            modelBuilder.Entity("Vitrina.Domain.Project.Page.VerificationResult", b =>
                {
                    b.HasOne("Vitrina.Domain.Project.Page.ProjectPage", "Page")
                        .WithOne()
                        .HasForeignKey("Vitrina.Domain.Project.Page.VerificationResult", "PageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
